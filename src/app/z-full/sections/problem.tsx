...
const problems = [
  {
    text: "Social, ads, automação, conteúdo — 4 fornecedores, 4 contratos, ninguém dono do resultado",
  },
  {
    text: "Você paga para atrair clientes. Sem bot para converter e fazer follow-up, metade deles some sem comprar",
  },
  {
    text: "Anúncio impacta o cliente. Ele busca o perfil, encontra pouca coisa, desconfia e não compra",
  },
  {
    text: "Campanha vai no ar, WhatsApp lota. Equipe não dá conta. Pedido perdido, cliente irritado",
  },
  {
    text: "Dados de social no Instagram, ads no Gerenciador, bot na plataforma — ninguém vê o ciclo completo",
  },
  {
    text: "Crescer com 4 fornecedores multiplica o custo administrativo. Não multiplica o resultado na mesma proporção",
  },
];

export function ZFullProblem() {
      ...
      <div className="relative bg-preto overflow-hidden">
        ...
        <div className="relative w-full overflow-hidden" style={{ height: "220px" }}>
          <motion.div
            ...
            style={{
              height: "220px",
              background: `linear-gradient(to bottom, ${LIME}CC 0%, ${LIME}1A 60%, transparent 100%)`,
          ...
          <motion.div
            ...
            style={{
              ...
              width: "600px",
              height: "140px",
              background: `radial-gradient(ellipse at 50% 0%, ${LIME}70 0%, ${LIME}28 40%, transparent 75%)`,
            }}
          />
          <motion.div
        ...
        >
            ...
            {problems.map((p, i) => (
              ...
              >
                <div
                  ...
                  style={{ background: `${LIME}20`, borderColor: `${LIME}40` }}
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
          ...
          >
            <p className="font-display text-sm text-white/40 italic max-w-xl mx-auto leading-relaxed">
              &ldquo;Quando social, ads e automação trabalham como um sistema, o cliente é atraído,
              convertido e fidelizado — sem brecha no ciclo.&rdquo;
            </p>
          </motion.div>
        </div>
      </div>
