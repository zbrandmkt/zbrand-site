...
const CHALLENGES = [
  "Quero uma estratégia integrada",
  "Gasto muito em fornecedores separados",
  "Quero automatizar o WhatsApp",
  "Preciso de presença em múltiplas redes",
  "Quero escalar com consistência",
  "Outro",
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-black text-white uppercase tracking-tight leading-[1.1] mb-4">
              Pronto para{" "}
              <TextRotate
                texts={["Escalar o Negócio", "Atrair no Meta e Google", "Fidelizar no WhatsApp", "Ter o Sistema Completo", "Dominar o Digital"]}
                interval={2800}
                className="block text-[#AAFF00]"
              />{" "}
              de verdade?
            </h2>

            <p className="font-display text-sm text-white/55 mb-8 leading-relaxed">
              Sem compromisso, sem papo técnico. Uma conversa direta sobre como o Pacote Full
              pode transformar o seu negócio num sistema completo de atração, conversão e fidelização.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 border-2 border-preto text-[#1A1A1A] font-black uppercase tracking-widest text-sm px-7 py-4 rounded-xl transition-all hover:-translate-y-0.5 self-start mb-8"
              style={{ backgroundColor: LIME, boxShadow: `4px 4px 0px 0px ${LIME}40` }}
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLAnchorElement).style.borderColor = LIME;
          ...
          >
            {submitted ? (
              <div
                ...
                style={{ boxShadow: `5px 5px 0px 0px ${LIME}` }}
              >
                ...
                <p className="font-display text-sm text-cinza-dark font-medium leading-relaxed">
                  ...
                  <span className="font-bold" style={{ color: LIME }}>
                    Bora colocar o sistema completo pra funcionar!
                  </span>
                </p>
              </div>
            ) : (
              ...
              >
                ...
                <button
                  ...
                  style={{ backgroundColor: LIME, boxShadow: "3px 3px 0px 0px #1A1A1A" }}
                >
