...
const CHALLENGES = [
  ...
  "Preciso de mais presença digital",
...
export function ZPersonalizadoCta() {
    ...
    try {
      ...
      if (supabase) {
        await supabase.from("leads").insert({
          ...
          services: "Pacote Personalizado",
          source: "z_personalizado_cta",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-black text-white uppercase tracking-tight leading-[1.1] mb-4">
              Pronto para{" "}
              <TextRotate
                texts={["Seu Pacote Perfeito", "Só o Que Você Precisa", "Do Seu Jeito", "Começar Agora", "Crescer com a ZBRAND"]}
                interval={2800}
                className="block text-[#7B2FF7]"
              />{" "}
              de verdade?
            </h2>

            <p className="font-display text-sm text-white/55 mb-6 leading-relaxed">
              Já montou seu pacote no configurador?{" "}
              <a href="#configurador" className="underline" style={{ color: PURPLE }}>
                Suba e finalize sua escolha ↑
              </a>
              {" "}ou preencha o formulário para uma conversa rápida.
            </p>

            {/* WhatsApp direct */}
            <a
              href={getWhatsAppLink("personalizado")}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 border-2 border-preto text-white font-black uppercase tracking-widest text-sm px-7 py-4 rounded-xl transition-all hover:-translate-y-0.5 self-start mb-8"
              style={{ backgroundColor: PURPLE, boxShadow: `4px 4px 0px 0px ${PURPLE}40` }}
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            {submitted ? (
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full border-2 border-preto text-white font-black uppercase tracking-widest text-sm py-3.5 rounded-xl transition-all hover:-translate-y-0.5 disabled:opacity-50"
                  style={{ backgroundColor: PURPLE, boxShadow: "3px 3px 0px 0px #1A1A1A" }}
                >
