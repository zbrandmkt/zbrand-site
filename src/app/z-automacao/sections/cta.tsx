...
const CHALLENGES = [
  ...
  "Quero parar de responder tudo manualmente",
  "Outro",
];
    ...
    try {
      ...
      if (supabase) {
        await supabase.from("leads").insert({
          ...
          services: "Automação (Z-AUTOMAÇÃO)",
          source: "z_automacao_cta",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-black text-white uppercase tracking-tight leading-[1.1] mb-4">
              Pronto para{" "}
              <TextRotate
                texts={["Automatizar", "Vender 24h", "Fidelizar Clientes", "Disparar Promoções", "Crescer no WhatsApp"]}
                interval={2800}
                className="block text-[#FBBC05]"
              />{" "}
              de verdade?
            </h2>

            <p className="font-display text-sm text-white/55 mb-8 leading-relaxed">
              Sem compromisso, sem papo técnico. Uma conversa direta para entender
              o seu negócio e mostrar como a automação pode funcionar para você.
            </p>
            ...
            <a
              ...
              style={{ backgroundColor: AMBER, boxShadow: `4px 4px 0px 0px ${AMBER}50` }}
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            {submitted ? (
              <div
                ...
                style={{ boxShadow: `5px 5px 0px 0px ${AMBER}` }}
              >
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    style={{ ["--tw-ring-color" as string]: AMBER }}
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-black uppercase tracking-widest text-preto/50">
                    Principal desafio no atendimento
                  </label>
                  <select
                    {...register("challenge")}
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-preto/15 rounded-xl text-preto text-sm focus:outline-none transition-colors font-medium appearance-none cursor-pointer"
                ...
                <button
                  ...
                  style={{ backgroundColor: AMBER, boxShadow: "3px 3px 0px 0px #1A1A1A" }}
                >
