...
const CHALLENGES = [
  "Meu perfil não cresce",
  "Gasto em ads mas não vejo retorno",
    ...
    try {
      ...
      if (supabase) {
        await supabase.from("leads").insert({
          ...
          services: "Pacote Starter",
          source: "z_starter_cta",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-black text-white uppercase tracking-tight leading-[1.1] mb-4">
              Pronto para{" "}
              <TextRotate
                texts={["Crescer no Instagram", "Anunciar no Meta", "Ter Mais Clientes", "Unir Social e Ads", "Começar no Starter"]}
                interval={2800}
                className="block text-[#FF6100]"
              />{" "}
              de verdade?
            </h2>

            <p className="font-display text-sm text-white/55 mb-8 leading-relaxed">
              Sem compromisso, sem papo técnico. Uma conversa direta sobre como o Pacote Starter
              pode transformar sua presença digital em clientes reais.
            </p>
            ...
            <a
              ...
              style={{ backgroundColor: ORANGE, boxShadow: `4px 4px 0px 0px ${ORANGE}40` }}
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            {submitted ? (
              <div
                ...
                style={{ boxShadow: `5px 5px 0px 0px ${ORANGE}` }}
              >
                ...
                <p className="font-display text-sm text-cinza-dark font-medium leading-relaxed">
                  ...
                  <span className="font-bold" style={{ color: ORANGE }}>
                    Bora colocar o Pacote Starter em ação!
                  </span>
                </p>
              </div>
            ) : (
              ...
              >
                ...
                <button
                  ...
                  style={{ backgroundColor: ORANGE, boxShadow: "3px 3px 0px 0px #1A1A1A" }}
                >
