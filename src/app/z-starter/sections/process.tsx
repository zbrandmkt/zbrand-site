...
const steps = [
  {
    ...
    time: "Semana 1",
    desc: "Briefing único cobrindo social e ads juntos. Mapeamento de perfil, público-alvo e objetivos. Uma reunião faz o trabalho de duas — sem perda de tempo.",
  },
  {
    number: "02",
    icon: "📋",
    ...
    title: "Criação & Setup",
    time: "Semana 2",
    desc: "Calendário editorial e estrutura das campanhas montados em paralelo pela mesma equipe. Mesma paleta visual, mesma voz de marca, mesma promoção.",
  },
  {
    number: "03",
    icon: "🎬",
    ...
    time: "Semanas 2–3",
    desc: "1 dia no seu negócio (4–6h). O mesmo material gravado serve para posts, stories e criativos de anúncio. Zero custo duplicado de produção.",
  },
  {
    number: "04",
    icon: "🚀",
    color: "#AAFF00",
    title: "Lançamento Simultâneo",
    time: "Semanas 3–4",
    desc: "Perfil ativo e campanhas no ar ao mesmo tempo. O cliente clica no anúncio e encontra um perfil profissional — prova social desde o primeiro anúncio.",
  },
  {
    number: "05",
    icon: "📊",
    ...
    time: "Meses 2+",
    desc: "Relatório unificado toda semana mostrando resultado de social e ads juntos. Ajustes em ambos os canais a partir dos mesmos dados. Reunião mensal de alinhamento.",
  },
];

export function ZStarterProcess() {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display font-black text-4xl lg:text-5xl text-preto uppercase tracking-tight leading-tight">
            Como a gente{" "}
            <span style={{ color: ORANGE }}>trabalha junto</span>
          </h2>
          <p className="mt-4 font-display text-base text-cinza-dark max-w-xl mx-auto leading-relaxed">
            Do briefing até os resultados — tudo integrado, sem ruído entre canais.
          </p>
        </motion.div>
