...
const steps = [
  ...
  },
  {
    ...
    desc: "Captamos o ambiente do negócio: cozinha em ação, salão, equipe trabalhando. O conteúdo que humaniza a marca e cria conexão com o cliente.",
  },
  {
    number: "03",
    time: "Hora 2",
    icon: "🍽️",
    color: "#00C2FF",
    title: "Pratos & Produtos",
    desc: "Filmagem dos pratos com apresentação, detalhe e textura. O conteúdo que dá fome, desperta desejo e converte visualização em pedido.",
  },
  {
    number: "04",
    time: "Hora 3–4",
