...
const CHALLENGES = [
  "Não tenho conteúdo de qualidade",
  "Meu conteúdo não tem qualidade",
  "Não tenho tempo para gravar",
  "Preciso de fotos profissionais",
  "Quero aparecer mais nas redes",
  "Outro",
];
    ...
    try {
      ...
      if (supabase) {
        await supabase.from("leads").insert({
          ...
          services: "Captação de Conteúdo",
          source: "z_captacao_cta",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <p className="font-display text-sm text-white/55 mb-8 leading-relaxed">
              Sem enrolação, sem orçamento surpresa. Uma conversa rápida sobre o seu negócio
              e a gente já sai com a sessão agendada.
            </p>
            ...
            <a
              ...
              style={{ backgroundColor: LIME, boxShadow: `4px 4px 0px 0px ${LIME}50` }}
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  style={
                    {
                      ["--hover-border" as string]: LIME,
                      ["--hover-text" as string]: LIME,
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="font-display text-sm text-cinza-dark font-medium leading-relaxed">
                  Você vai receber uma mensagem no WhatsApp em até 1 hora.{" "}
                  <span className="font-bold" style={{ color: LIME }}>
                    Bora agendar sua sessão!
                  </span>
                </p>
              </div>
            ) : (
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    style={{ ["--focus-border" as string]: LIME } as React.CSSProperties}
                  />
                  {errors.name && (
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-black uppercase tracking-widest text-preto/50">
                    Principal desafio com conteúdo
                  </label>
                  <select
                    {...register("challenge")}
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-preto/15 rounded-xl text-preto text-sm focus:outline-none transition-colors font-medium appearance-none cursor-pointer"
                ...
                >
                  {loading ? "Enviando..." : "QUERO AGENDAR UMA SESSÃO →"}
                </button>
