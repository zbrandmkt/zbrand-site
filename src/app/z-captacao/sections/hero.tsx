...
const stats = [
  { value: "10", label: "vídeos editados" },
  { value: "4h", label: "de sessão presencial" },
  { value: "10 dias", label: "prazo de entrega" },
  { value: "3 planos", label: "Mobile, Pro e Eventos" },
];

export function ZCaptacaoHero() {
  return (
    <InfiniteGrid
      className="relative min-h-[92vh] flex items-center justify-center pt-[88px]"
      gridColor="rgba(0,0,0,0.07)"
      glowColor="rgba(170,255,0,0.10)"
    >
      {/* Glow background */}
      <div
      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col items-center text-center">
        ...
        >
          ...
          >
            10 Vídeos.{" "}
            <span style={{ color: LIME }}>1 Dia.</span>
            <br />
            Conteúdo para o{" "}
            <span className="text-laranja">Mês Inteiro.</span>
          </motion.h1>
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center gap-2.5 font-display font-black text-sm uppercase tracking-widest px-8 py-4 border-2 border-preto rounded-brutal text-preto"
              style={{
