                ...
                >
                  ...
                  <div className="flex flex-col gap-2 mb-2">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2.5 border-2 border-[#1A1A1A]/15 rounded-xl py-2.5 text-xs font-bold text-[#1A1A1A]/70 hover:border-[#1A1A1A] hover:text-[#1A1A1A] transition-all"
                    ...
                    >
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none">
                        <path d="M11.5 3L3 7.5v9L11.5 21l8.5-4.5v-9L11.5 3z" fill="#00A4EF"/>
                        <path d="M11.5 3v18M3 7.5l8.5 4.5M20 7.5l-8.5 4.5" stroke="#fff" strokeWidth="1" strokeOpacity="0.4"/>
                      </svg>
                  ...
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-[#1A1A1A]/30">ou</span>
                    <div className="flex-1 h-px bg-[#1A1A1A]/10" />
                  </div>
