...
const steps = [
  ...
  },
  {
    ...
    desc: "Estrutura completa das campanhas, definição de verba por objetivo, pixel de rastreamento configurado e criativos iniciais prontos para veicular.",
  },
  {
    number: "03",
    icon: "🎬",
  ...
  },
  {
    ...
    desc: "Publicação das campanhas com acompanhamento diário. Ajustes finos de público, criativo e horário para maximizar o retorno de cada real investido.",
  },
  {
    number: "05",
    icon: "📊",
    ...
    desc: "Reunião mensal de alinhamento, relatório semanal com retorno real dos anúncios, novos criativos e escala gradual do investimento conforme os resultados crescem.",
  },
];

export function ZAdsProcess() {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display font-black text-4xl lg:text-5xl text-preto uppercase tracking-tight leading-tight">
            Como a gente{" "}
            <span className="text-[#00C2FF]">trabalha</span>
          </h2>
          <p className="mt-4 font-display text-base text-cinza-dark max-w-xl mx-auto leading-relaxed">
            Do primeiro contato até os anúncios no ar — você acompanha cada etapa sem nenhuma surpresa.
          </p>
        </motion.div>
