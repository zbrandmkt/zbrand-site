...
const CHALLENGES = [
  "Verba queimada sem resultado",
  "Não sei se meus anúncios funcionam",
  "Não tenho conteúdo para anunciar",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-black text-white uppercase tracking-tight leading-[1.1] mb-4">
              Pronto para ter{" "}
              <TextRotate
                texts={["Meta Ads", "Google Ads", "Criativos", "Resultado Real", "Tráfego Pago"]}
                interval={2800}
                className="block text-[#00C2FF]"
              />{" "}
              de verdade?
            </h2>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 border-2 border-[#00C2FF] text-[#1A1A1A] font-black uppercase tracking-widest text-sm px-7 py-4 rounded-xl transition-all hover:-translate-y-0.5 self-start mb-8"
              style={{ backgroundColor: "#00C2FF", boxShadow: "4px 4px 0px 0px rgba(0,194,255,0.3)" }}
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.label}
                  className="w-10 h-10 border-2 border-white/15 rounded-xl flex items-center justify-center text-white/50 hover:border-[#00C2FF] hover:text-[#00C2FF] hover:bg-[#00C2FF]/10 transition-all"
                >
                  {s.icon}
                </a>
              ))}
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="font-display text-sm text-cinza-dark font-medium leading-relaxed">
                  ...
                  <span className="font-bold" style={{ color: "#00C2FF" }}>
                    Bora transformar seus anúncios em clientes!
                  </span>
                </p>
              </div>
            ) : (
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-preto/15 rounded-xl text-preto text-sm placeholder:text-preto/25 focus:border-[#00C2FF] focus:outline-none transition-colors font-medium"
                  />
                  {errors.name && (
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-preto/15 rounded-xl text-preto text-sm focus:border-[#00C2FF] focus:outline-none transition-colors font-medium appearance-none cursor-pointer"
                  >
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-black uppercase tracking-widest text-preto/50">
                    Principal desafio com anúncios
                  </label>
                  <select
                    {...register("challenge")}
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-preto/15 rounded-xl text-preto text-sm focus:border-[#00C2FF] focus:outline-none transition-colors font-medium appearance-none cursor-pointer"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full border-2 border-preto text-[#1A1A1A] font-black uppercase tracking-widest text-sm py-3.5 rounded-xl transition-all hover:-translate-y-0.5 disabled:opacity-50"
                  style={{ backgroundColor: "#00C2FF", boxShadow: "3px 3px 0px 0px #1A1A1A" }}
                >
