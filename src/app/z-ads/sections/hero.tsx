...
export function ZAdsHero() {
  return (
    ...
    >
      {/* Glow background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#00C2FF]/5 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col items-center text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-[#00C2FF]/10 border border-[#00C2FF]/20 rounded-full mb-8"
          >
            <span className="w-1.5 h-1.5 bg-[#00C2FF] rounded-full animate-pulse-glow" />
            <span className="font-display text-[11px] font-black text-[#00C2FF] uppercase tracking-widest">
              Z-ADS — Gestão de Tráfego Pago
            </span>
          </motion.div>
          ...
          >
            A gente <span className="text-preto font-semibold">estrutura, filma, edita e otimiza</span> suas campanhas no
            Meta e Google Ads. Enquanto você cuida do negócio, a gente cuida dos seus anúncios.
          </motion.p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4">
              {stats.map((s, i) => (
                <div
                  ...
                  `}
                >
                  <span className="font-display font-black text-lg text-[#00C2FF] leading-none">
                    {s.value}
                  </span>
