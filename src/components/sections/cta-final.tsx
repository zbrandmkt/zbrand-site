        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-black text-white uppercase tracking-tight leading-tight mb-4">
              Bora tirar a zebra do seu{" "}
              <span className="text-[#FF6100]">marketing?</span>
            </h2>

            <p className="font-display text-sm text-white/55 mb-8 leading-relaxed">
              Conta pra gente sobre o seu negócio. Após finalizar o formulário a{" "}
              <span className="text-[#FF6100] font-bold">Zee</span>, nossa assistente de IA,
              vai te passar todos os valores rapidinho para já darmos início no seu projeto.
            </p>
            ...
            <div className="flex items-center gap-3 mb-8">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-10 h-10 border-2 border-white/15 rounded-xl flex items-center justify-center text-white/50 hover:border-[#FF6100] hover:text-[#FF6100] hover:bg-[#FF6100]/10 transition-all"
                >
                  {s.icon}
                </a>
              ))}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-[#FF6100] border-2 border-[#FF6100] text-white font-black uppercase tracking-widest text-sm px-7 py-4 rounded-xl transition-all hover:-translate-y-0.5 self-start"
          ...
          >
            {submitted ? (
              <div
                className="bg-white border-2 border-[#1A1A1A] rounded-2xl p-8 text-center"
                style={{ boxShadow: "5px 5px 0px 0px #FF6100" }}
              >
                <span className="text-5xl mb-4 block">🦓</span>
                <h3 className="font-display font-black text-xl text-[#1A1A1A] uppercase mb-2">
                  Recebemos sua mensagem!
                </h3>
                <p className="text-sm text-[#1A1A1A]/55 font-medium">
                  A Zee vai te chamar assim que processar o formulário ⚡
                </p>
              </div>
            ) : (
              <form
                onSubmit={handleSubmit(onSubmit)}
                className="bg-white border-2 border-[#1A1A1A] rounded-2xl p-6 flex flex-col gap-4"
                style={{ boxShadow: "5px 5px 0px 0px #FF6100" }}
              >
                {/* Nome */}
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-[#1A1A1A]/15 rounded-xl text-[#1A1A1A] text-sm placeholder:text-[#1A1A1A]/30 focus:border-[#FF6100] focus:outline-none transition-colors font-medium"
                  />
                  {errors.name && (
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <textarea
                    {...register("message")}
                    placeholder="Quantas unidades, faturamento atual, maior desafio..."
                    rows={3}
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-[#1A1A1A]/15 rounded-xl text-[#1A1A1A] text-sm placeholder:text-[#1A1A1A]/30 focus:border-[#FF6100] focus:outline-none transition-colors resize-none font-medium"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#1A1A1A] border-2 border-[#1A1A1A] text-white font-black uppercase tracking-widest text-sm py-3.5 rounded-xl transition-all hover:-translate-y-0.5 disabled:opacity-50"
                  style={{ boxShadow: "3px 3px 0px 0px #FF6100" }}
                >
                  {loading ? "Enviando..." : "ENVIAR MENSAGEM"}
                </button>

                <p className="text-[10px] text-[#1A1A1A]/35 text-center font-medium">
                  A Zee vai te chamar assim que enviar o formulário ⚡
                </p>
              </form>
            )}
          </motion.div>
